        ...
        <div className="container">
            <div>
                <nav className="mb-4 navbar navbar-expand-lg navbar-dark bg-unique hm-gradient">
                    <a href="/#" className="navbar-brand Company-Log" onClick={(e) => handleLogoClick(e)}>OLLEC AIRLINES</a>
            ...
            <div>
                <ul className="nav nav-pills">
                    ...
                    <li className="nav-item">
                        <a href="/#" className="nav-link waves-effect waves-light" onClick={e => handleUserIcon(e)}><i className="fa fa-user user"></i> Profile</a>
                    </li>
                ...
                <div className="tab-content">
                    ...
                    <div className="tab-pane container fade mn-box" id="menu8"><Profile /></div>
                    <br></br>
