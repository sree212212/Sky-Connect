...
export default function ChangingFeatures() {
    ...
    return (
        <div>
            ...
            <table>
                <tr>
                    <th style={{ color: "rgb(44, 237, 224)" }}>Features</th>
                    <th style={{ color: "rgb(44, 237, 224)" }}>Economy</th>
                    <th>Business</th>
                    <th>First Class</th>
                </tr>
                <tr>
                    <td style={{ color: "rgb(44, 237, 224)" }}>Seat Pitch</td>
                    <td>
                ...
                <tr>
                    <td style={{ color: "rgb(44, 237, 224)" }}>Seat Type</td>
                    <td>
            ...
            <div style={{
                marginLeft: "27%"
            }}><input type="submit" onClick={e => { moveToCancelPage(e) }} className=" btn btn-primary btn-md getRoute" style={{ color: "rgb(44, 237, 224)" }} /></div>
        </div>
